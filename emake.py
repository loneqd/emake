...
if __name__ == '__main__':
    ...
    def test2():
        ...
        pp = pst.preprocess(open('voice/fastvoice/basewave.cpp', 'U').read())
        print(pp)
    ...
    def test10():
        sys.argv = [sys.argv[0], '-g', 'default', 'd:/dev/flash/alchemy5/tutorials/01_HelloWorld/hello.exe',
                    '--version']
        main()
